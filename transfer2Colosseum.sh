...
sshpass -p "ChangeMe" ssh $3 'docker exec sample-xapp-24 cp /home/sample-xapp/traffic_gen/mv_ts_files.sh /home/ && docker exec sample-xapp-24 chmod +x /home/mv_ts_files.sh'
